...
#ifndef GEMONASTREET_TRADER_H
#define GEMONASTREET_TRADER_H

#include <bits/stdc++.h>

#include <boost/asio/io_context.hpp>

#include "libs/ready_trader_go/baseautotrader.h"
#include "libs/ready_trader_go/types.h"
#include "MarketState.cpp"
#include "LIVStrategy.cpp"
#include "IntersectionStrategy.cpp"
...
private:
    unsigned int mNextMessageId = 1;
    map<unsigned long, pair<unsigned long, unsigned int> > asks;
    map<unsigned long, pair<unsigned long, unsigned int> > bids;
    map<unsigned long, pair<unsigned long, unsigned int> > hAsks;
    map<unsigned long, pair<unsigned long, unsigned int> > hBids;
    set<unsigned long> marketMaking;
    signed int etf = 0;
    signed int fut=0;
    signed int money = 0;
    ...
    bool checkLots(Instrument instrument, signed int request);
