...
"""
A naive (the spread THRESHOLD between ETF and FUTURE price is chosen euristically and not dynamically) implementation of a statistical-arbitrage method.
"""
...
class AutoTrader(BaseAutoTrader):
    ...
    def on_hedge_filled_message(self, client_order_id: int, price: int, volume: int) -> None:
        ...
        #print("fut: ", self.fut, "money: ", self.soldi)
    ...
    def on_order_book_update_message(self, instrument: int, sequence_number: int, ask_prices: List[int],
        ...
        self.logger.info("received order book for instrument %d with sequence number %d", instrument,
                         sequence_number)
        if sequence_number < 2: #Wait a bit
            return
